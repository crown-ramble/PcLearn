...
## 🛠️ سکرت اتصال جدید:
```text
eed34e5658e41a995252834b92b6a95f7777772e636c6f7564666c6172652e636f6d
```

---

## 💻 دستورات ارسال تغییرات به گیت‌هاب (Git Push):
```powershell
cd C:\Users\Ali\.gemini\antigravity\scratch\telegram-proxy-railway
git add .
